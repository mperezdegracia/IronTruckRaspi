...
MbPage {
	...
	summary: (errorCode.valid && errorCode.value !== 0 ? "Error " + errorCode.value : yield.item.text)
...
*/
		MbItemRow {
			...
			values: [
				...
				MbTextBlock { id: yield; item.bind: service.path("/Yield/Power"); width: 90; height: 25 }
			]
		}
