...
ListModel {
	...
	ListElement {name: QT_TR_NOOP("E. Europe Standard Time"); city: "Minsk"; group: "(GMT +02:00) Minsk"}
	ListElement {name: QT_TR_NOOP("FLE Standard Time"); city: "Kiev"; group: "(GMT +02:00) Helsinki, Kyiv, Riga, Sofia, Tallinn, Vilnius"}
	ListElement {name: QT_TR_NOOP("GTB Standard Time"); city: "Istanbul"; group: "(GMT +02:00) Athens, Bucharest, Istanbul"}
