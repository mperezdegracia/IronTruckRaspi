				...
				MbPage {
					...
					model: VisualItemModel {
						MbSwitch {
							...
							bind: Utils.path(bindPrefix, "/Settings/AnalogInput/Resistive/1/Function")
							show: valid
						...
						MbSwitch {
							...
							bind: Utils.path(bindPrefix, "/Settings/AnalogInput/Resistive/2/Function")
							show: valid
							onCheckedChanged: if (valid && !checked) rebootToRemoveToast()
						}
						...
						MbSwitch {
							...
							bind: Utils.path(bindPrefix, "/Settings/AnalogInput/Resistive/3/Function")
							show: valid
							onCheckedChanged: if (valid && !checked) rebootToRemoveToast()
						}
						...
						MbSwitch {
							...
							bind: Utils.path(bindPrefix, "/Settings/AnalogInput/Temperature/1/Function")
							show: valid
							onCheckedChanged: if (valid && !checked) rebootToRemoveToast()
						}
						...
						MbSwitch {
							...
							bind: Utils.path(bindPrefix, "/Settings/AnalogInput/Temperature/2/Function")
							show: valid
							onCheckedChanged: if (valid && !checked) rebootToRemoveToast()
						}
					}
